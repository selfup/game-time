...
var drawOne = () => {
  ...
  context.fillRect(game.bikeOne.x - 2, game.bikeOne.y, game.bikeOne.width, game.bikeOne.height)
}

var drawTwo = () => {
  context.fillStyle = "#FFFF00"
  context.fillRect(game.bikeTwo.x + 2, game.bikeTwo.y, game.bikeTwo.width, game.bikeTwo.height)
}
...
var resetGame = () => {
    $('#reset').on('click', (event) => {
      ...
      game.grid.firstBikeTrail = [[0, 150]]
      game.grid.secondBikeTrail = [[450, 150]]
